        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-item @php if(\Request::path() == 'client/admin18/dashboard18')echo "
                                menu-open" @endphp">
                                <a href="/client/admin18/dashboard18" class="nav-link">
                            ...
                            <li class="nav-item @php if(\Request::path() == 'client/admin18/data-agama18')echo "
                                menu-open" @endphp">
                                <a href="/client/admin18/data-agama18" class="nav-link">
            ...
            <footer class="main-footer">
                <div class="float-right d-none d-sm-inline-block">
                    &copy; <b>V3421018 - A - Aulia Akbar Khoiruddin</b>
                </div>
            </footer>
        </div>
        <!-- ./wrapper -->
